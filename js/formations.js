...
export const POSITIONS = {
  ...
  KP:  'Keskuspuolustaja',
  DKK: 'Defensiivinen keskikenttä',
  KK:  'Keskikenttä',
  OKK: 'Oikea keskikenttä',
  VKK: 'Vasen keskikenttä',
  HKK: 'Hyökkäävä keskikenttä',
...
export const ROLES = ['MV', 'LP', 'KP', 'DKK', 'KK', 'HKK', 'LH', 'KH'];
export const ROLE_NAMES = {
  MV: 'Maalivahti', LP: 'Laitapuolustaja', KP: 'Keskuspuolustaja',
  DKK: 'Def. keskikenttä', KK: 'Keskikenttä', HKK: 'Hyökkäävä kk',
...
export const FORMATIONS = [
  ...
  { id: '4-3-3', name: '4-3-3', size: 11, slots: [
    s('MV',50,89), s('VLP',13,74), s('KP',36,78), s('KP',64,78), s('OLP',87,74),
    s('DKK',50,60), s('KK',27,48), s('KK',73,48), s('VLH',15,24), s('KH',50,16), s('OLH',85,24) ]},
  { id: '4-2-3-1', name: '4-2-3-1', size: 11, slots: [
    s('MV',50,89), s('VLP',13,74), s('KP',36,78), s('KP',64,78), s('OLP',87,74),
    s('DKK',34,60), s('DKK',66,60), s('VLH',14,38), s('HKK',50,36), s('OLH',86,38), s('KH',50,16) ]},
  { id: '4-5-1', name: '4-5-1', size: 11, slots: [
    s('MV',50,89), s('VLP',13,74), s('KP',36,78), s('KP',64,78), s('OLP',87,74),
    s('VKK',11,50), s('KK',32,54), s('DKK',50,62), s('KK',68,54), s('OKK',89,50), s('KH',50,20) ]},
  { id: '3-5-2', name: '3-5-2', size: 11, slots: [
    s('MV',50,89), s('KP',27,78), s('KP',50,80), s('KP',73,78),
    s('VKK',11,52), s('KK',33,54), s('DKK',50,62), s('KK',67,54), s('OKK',89,52), s('KH',38,20), s('KH',62,20) ]},
  ...
  { id: '5-3-2', name: '5-3-2', size: 11, slots: [
    ...
    s('KK',28,50), s('DKK',50,58), s('KK',72,50), s('KH',38,20), s('KH',62,20) ]},
  ...
  { id: '7-2-1-2-1', name: '2-1-2-1', size: 7, slots: [
    s('MV',50,88), s('KP',30,76), s('KP',70,76), s('DKK',50,58),
...
const POS_TO_ROLE = {
  MV: 'MV', OLP: 'LP', VLP: 'LP', KP: 'KP', DKK: 'DKK',
  KK: 'KK', OKK: 'KK', VKK: 'KK', HKK: 'HKK', OLH: 'LH', VLH: 'LH', KH: 'KH',
};
