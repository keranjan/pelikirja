...
const MODULES = [
  ...
  'js/drills.js', 'js/tournaments.js', 'js/store.js',
  'js/merge.js', 'js/sync.js', 'js/ui.js', 'js/lineup-image.js',
  'js/views/pitch.js', 'js/views/drills.js', 'js/views/tournaments.js', 'js/views/tracking.js', 'js/views/players.js', 'js/views/matches.js', 'js/views/home.js',
